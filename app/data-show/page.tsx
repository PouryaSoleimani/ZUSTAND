    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-center gap-12 font-bold text-2xl'>
                <button className='p-3 border rounded box-border hover:border-emerald-500 hover:border-4' onClick={() => addDatas(data)} >add 1</button>
                <button className='p-3 border rounded box-border hover:border-red-500 hover:border-4' onClick={() => deleteDatas()}>delete</button>
            </div>
        </div>
    )
}
