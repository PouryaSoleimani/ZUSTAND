    ...
    return (
        <ul className='bg-zinc-800 p-3 rounded my-3'>
            ...
            {todos.map((todo: TodoType) => (
                <li key={todo.id} onClick={() => toggleTodo(todo.id)} className='bg-black p-2 rounded space-x-5 my-2 text-xl flex items-center justify-between w-1/3 font-black border border-zinc-500'>
                    <span
